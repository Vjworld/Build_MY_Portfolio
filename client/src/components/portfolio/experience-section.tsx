    ...
    <section className="py-24 bg-muted">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A comprehensive journey through {experiences.length}+ years of experience in project management, SaaS delivery, and technology leadership across BFSI, EdTech, and enterprise domains.
          </p>
        </div>
